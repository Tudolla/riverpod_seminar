...
import 'package:riverpod_seminar/pages/data/cart_change_notifier_provider.dart';

class ChangeNotifierProvierPage extends ConsumerWidget {
  const ChangeNotifierProvierPage({super.key});
