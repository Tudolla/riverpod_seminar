...
import 'package:riverpod_seminar/pages/data/cart_state_notifier.dart';

class StateNofifierProviderPage extends ConsumerWidget {
  const StateNofifierProviderPage({super.key});
